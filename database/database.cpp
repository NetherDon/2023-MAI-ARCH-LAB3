...
namespace database{
    Database::Database(){
        ...
        _connection_string+=Config::get().getHost();
        _connection_string+="; user=";
        _connection_string+=Config::get().getLogin();
        _connection_string+="; db=";
        _connection_string+=Config::get().getDatabase();
        _connection_string+="; port=";
        _connection_string+=Config::get().getPort();
        _connection_string+="; password=";
        _connection_string+=Config::get().getPassword();
